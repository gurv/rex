...
// use rex_app::commands::debug::DebugCommands;
// use rex_app::commands::docker::DockerCommands;
// use rex_app::commands::extension::ExtensionCommands;
// use rex_app::commands::migrate::MigrateCommands;
// use rex_app::commands::query::QueryCommands;
// use rex_app::commands::sync::SyncCommands;
// use rex_app::commands::toolchain::ToolchainCommands;
