...
pub struct RexBuildConfig {
    #[serde(skip_serializing_if = "Vec::is_empty")]
    #[setting(env = "REX_BUILD_EXCLUDE_PACKAGES", parse_env = env::split_comma)]
    pub exclude_packages: Vec<String>,

    #[setting(
        default = true,
        env = "REX_BUILD_INSTALL_SYSTEM_PACKAGES",
    ...
    #[setting(env = "REX_BUILD_WRITE_LOG_FILE", parse_env = env::parse_bool)]
...
#[derive(Clone, Config, Debug, Serialize)]
#[serde(rename_all = "kebab-case")]
pub struct RexOfflineConfig {
    #[serde(skip_serializing_if = "Vec::is_empty")]
    #[setting(env = "REX_OFFLINE_HOSTS", parse_env = env::split_comma)]
    pub custom_hosts: Vec<String>,

    #[setting(env = "REX_OFFLINE_OVERRIDE_HOSTS", parse_env = env::parse_bool)]
    pub override_default_hosts: bool,

    #[setting(default = 750, env = "REX_OFFLINE_TIMEOUT")]
    pub timeout: u64,
}
...
#[derive(Clone, Config, Debug, Serialize)]
#[serde(rename_all = "kebab-case")]
pub struct RexSettingsConfig {
    #[setting(env = "REX_AUTO_CLEAN", parse_env = env::parse_bool)]
    pub auto_clean: bool,

    #[setting(env = "REX_AUTO_INSTALL", parse_env = env::parse_bool)]
    pub auto_install: bool,

    #[setting(nested)]
    pub build: RexBuildConfig,

    #[setting(default = default_builtin_plugins)]
    pub builtin_plugins: BuiltinPlugins,

    #[setting(env = "REX_CACHE_DURATION")]
    pub cache_duration: Option<u64>,

    #[setting(env = "REX_DETECT_STRATEGY")]
    ...
    #[setting(nested)]
    pub offline: RexOfflineConfig,

    #[serde(skip_serializing_if = "Option::is_none")]
    #[setting(env = "REX_PIN_LATEST")]
