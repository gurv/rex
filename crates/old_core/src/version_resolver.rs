use crate::config::RexToolConfig;
use crate::tool_manifest::ToolManifest;
use rex_pdk_api::LoadVersionsOutput;
...
pub struct VersionResolver<'tool> {
    ...
    config: Option<&'tool RexToolConfig>,
}
...
impl<'tool> VersionResolver<'tool> {
    ...
    pub fn with_config(&mut self, config: &'tool RexToolConfig) {
