...
use rex_pdk_api::{
    ...
    ExecCommandInput, ExtendCommandInput, ExtendCommandOutput,
};
use rex_process::{Command, CommandArg, EnvBehavior};
// use rex_project::Project;
// use rex_task::Task;
// use rex_toolchain::{
...
impl<'app> AugmentedCommand<'app> {
    ...
    //     // If not using globals, inherit proto and rex paths
    //     if !is_using_global_toolchains(self.bag) {
    //         let rex = &self.context.toolchain_registry.host_data.rex_env;
