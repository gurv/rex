...
use rex_old_core::flow::locate::Locator as LocatorFlow;
use rex_old_core::{
    ConfigMode, Id, PluginLocator, RexToolConfig, ToolContext, ToolManifest, ToolMetadata,
...
pub async fn info(session: RexSession, args: InfoPluginArgs) -> AppResult {
