...
use rex_old_core::flow::manage::Manager;
use rex_old_core::{
    PluginLocator, RexEnvironment, RexLoaderError, Tool, ToolContext, ToolSpec,
    UnresolvedVersionSpec, flow::install::InstallOptions, load_tool_from_locator,
    rex_warpgate::FileLocator, rex_warpgate::UrlLocator,
};
...
where
    F: FnOnce(&RexEnvironment) -> Fut,
    Fut: Future<Output = Result<Tool, RexLoaderError>>,
{
    let sandbox = create_empty_rex_sandbox();
    let proto = RexEnvironment::new_testing(sandbox.path()).unwrap();
...
mod plugins {
    ...
    mod builtins {
        ...
        #[test]
        #[ignore = "unrecognized subcommand \'install\'"]
        fn supports_bun() {
            let sandbox = create_empty_rex_sandbox();
            ...
            create_bin_command(sandbox.path(), "bun")
                .arg("--version")
                .assert()
                .success();
        ...
        fn supports_deno() {
            ...
            create_bin_command(sandbox.path(), "deno")
                .arg("--version")
                .assert()
                .success();
        ...
        fn supports_go() {
            ...
            create_bin_command(sandbox.path(), "go")
                .arg("version")
                .assert()
                .success();
        ...
        fn supports_moon() {
            ...
            create_bin_command(sandbox.path(), "moon")
                .arg("--version")
                .assert()
                .success();
        ...
        fn supports_node_and_package_managers() {
            ...
            create_bin_command(sandbox.path(), "node")
                .arg("--version")
                .assert()
                .success();
            ...
            create_bin_command(sandbox.path(), "npm")
                .arg("--version")
                .assert()
                .success();
            ...
            create_bin_command(sandbox.path(), "pnpm")
                .arg("--version")
                .assert()
                .success();
            ...
            create_bin_command(sandbox.path(), "yarn")
                .arg("--version")
                .assert()
                .success();
        ...
        fn supports_python() {
            ...
            create_bin_command(sandbox.path(), "python")
                .arg("--version")
        ...
        fn supports_poetry() {
            ...
            create_bin_command(sandbox.path(), "poetry")
                .arg("--version")
                .assert()
                .success();
        ...
        fn supports_uv() {
            ...
            create_bin_command(sandbox.path(), "uv")
                .arg("--version")
                .assert()
                .success();
        ...
        fn supports_ruby() {
            ...
            create_bin_command(sandbox.path(), "ruby")
                .arg("--version")
                .assert()
                .success();
        ...
        //     let sandbox = create_empty_rex_sandbox_with_tools("toml");
        ...
        //     let sandbox = create_empty_rex_sandbox_with_tools("json");
        ...
        //     let sandbox = create_empty_rex_sandbox_with_tools("yaml");
