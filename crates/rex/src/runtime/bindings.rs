//! This module contains all the Wasmtime component bindings for the Rex runtime.
...
/// Generated bindings used to call components that implement the `vg:rex/plugin` interface
pub mod plugin {
    wasmtime::component::bindgen!({
        path: "./wit",
        world: "rex-plugin",
        ...
        async: true,
        with: {
            "vg:rex/types/runner": crate::runtime::plugin::Runner,
            "vg:rex/types/project-config": crate::runtime::plugin::ProjectConfig,
            "vg:rex/types/plugin-config": crate::runtime::plugin::PluginConfig,
            "vg:rex/types/context": crate::runtime::plugin::Context,
        }
    });
    ...
    use std::fmt::Display;
    use tracing::debug;
    use vg::rex::types::{CommandArgument, HookType};

    use crate::runtime::bindings::plugin::vg::rex::types::Metadata;
    ...
    impl From<&Metadata> for clap::Command {
        fn from(arg: &Metadata) -> Self {
            ...
            if let Some(cmd) = arg.command.as_ref() {
                // Register command under `rex <command-name>`
                ...
                // Register subcommands under `rex <plugin-name> <subcommand-name>`
