...
/// WASI interfaces with [wasmtime_wasi::add_to_linker_async] and linking the rex host
/// interface.
pub async fn prepare_component_plugin(
    ...
    let component = wasmcloud_runtime::component::CustomCtxComponent::new_with_linker_minimal(
        ...
        |linker, _component| {
            ...
            // Plugin host
            bindings::plugin::RexPlugin::add_to_linker(linker, |ctx| ctx)
                .context("failed to link `vg:rex/plugin`")?;
            Ok(())
        },
    )?;
...
pub async fn prepare_component_dev(
    ...
    let component = wasmcloud_runtime::component::CustomCtxComponent::new_with_linker_minimal(
        ...
        |linker, component| {
            ...
            bindings::plugin::RexPlugin::add_to_linker(linker, |ctx| ctx)
                .context("failed to link `vg:rex` host interface")?;
