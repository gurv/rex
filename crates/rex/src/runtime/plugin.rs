//! Types and implementations for the vg:rex plugin host interface
...
use crate::runtime::{Ctx, bindings::plugin::exports::vg::rex::plugin::Metadata};
...
impl crate::runtime::bindings::plugin::vg::rex::types::Host for Ctx {}
/// The Context resource is a passthrough to the same map we use for runtime configuration
impl crate::runtime::bindings::plugin::vg::rex::types::HostContext for Ctx {
...
impl crate::runtime::bindings::plugin::vg::rex::types::HostProjectConfig for Ctx {
...
impl crate::runtime::bindings::plugin::vg::rex::types::HostRunner for Ctx {
...
impl crate::runtime::bindings::plugin::vg::rex::types::HostPluginConfig for Ctx {
