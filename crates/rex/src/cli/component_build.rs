...
// use crate::runtime::bindings::plugin::vg::rex::types::HookType;
...
//     /// Path to a configuration file in a location other than PROJECT_DIR/.rex/config.json
...
//                 // Generate project config to ensure .rex/config.json exists with placeholder
...
//                 let config_dir = self.project_path.join(".rex");
//                 let config_path = config_dir.join("config.json");
//                 tokio::fs::create_dir_all(&config_dir)
//                     .await
//                     .context("failed to create .rex directory")?;
