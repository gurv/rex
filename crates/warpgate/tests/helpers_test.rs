...
use rex_warpgate::{from_virtual_path, sort_virtual_paths, to_virtual_path};

#[test]
fn sorts_virtual_paths() {
    let paths = BTreeMap::from_iter([
        (PathBuf::from("/Users/warp"), PathBuf::from("/userhome")),
        (PathBuf::from("/Users/warp/.rex"), PathBuf::from("/rex")),
        (
            PathBuf::from("/Users/warp/.rex/temp"),
            PathBuf::from("/temp"),
        ),
        (
            PathBuf::from("/Users/warp/Projects/rex/example"),
    ...
    assert_eq!(
        sort_virtual_paths(&paths)
            ...
            .collect::<Vec<_>>(),
        [
            ("/Users/warp/Projects/rex/example", "/workspace"),
            ("/Users/warp/Projects/other/length", "/workdir"),
            ("/Users/warp/.rex/temp", "/temp"),
            ("/Users/warp/.rex", "/rex"),
            ("/Users/warp", "/userhome"),
            ("/Other/path", "/cwd")
        ]
