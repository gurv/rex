...
// use rex_action_graph::{ActionGraphBuilder, ActionGraphBuilderOptions};
use rex_api::Launchpad;
use rex_app_context::AppContext;
use rex_cache::CacheEngine;
// use rex_codegen::CodeGenerator;
...
// use rex_console::{Console, create_console_theme};
...
// use rex_project_graph::ProjectGraph;
// use rex_task_graph::TaskGraph;
// use rex_toolchain_plugin::*;
// use rex_vcs::{BoxedVcs, git::Git};
// use rex_workspace::WorkspaceBuilder;
// use rex_workspace_graph::WorkspaceGraph;
...
//         if self.requires_workspace_configured() {
//             Launchpad::register(self.rex_env.clone())?;
//         }
...
//                 &self.console,
//                 &cache_engine,
//                 &self.toolchains_config.rex.manifest_url,
//             )
//             .await?;
//         }
